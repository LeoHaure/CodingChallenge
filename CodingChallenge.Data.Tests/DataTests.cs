...
namespace CodingChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        [TestCase] // TEST ADICIONAL LEONEL     ************************ -> NUEVO IDIOMA Italiano + NUEVAS FORMA Rectangulo
        public void TestResumenListaConUnRectanguloEnItaliano()
        {
            var rectangulos = new List<FormaGeometrica> { new FormaGeometrica(FormaGeometrica.Rectangulo, 5, 8) };

            var resumen = FormaGeometrica.Imprimir(rectangulos, FormaGeometrica.Italiano);

            Assert.AreEqual("<h1>Rapporto sui moduli</h1>1 Rettangolo | La zona 40 | Perimetro 26 <br/>TOTALE:<br/>1 formes Perimetro 26 La zona 40", resumen);
        }
        ...
        [TestCase] // TEST ADICIONAL LEONEL     ************************ -> NUEVO IDIOMA Italiano + NUEVAS FORMAS Rectangulo y Trapecio
        public void TestResumenListaConMasTiposEnItaliano()
        {
            var formas = new List<FormaGeometrica>
            {
                ...
                new FormaGeometrica(FormaGeometrica.Cuadrado, 2),
                new FormaGeometrica(FormaGeometrica.TrianguloEquilatero, 9),
                new FormaGeometrica(FormaGeometrica.Rectangulo,  5, 8),
                new FormaGeometrica(FormaGeometrica.Trapecio, 6, 7, 8, 9, 10)
            };

            var resumen = FormaGeometrica.Imprimir(formas, FormaGeometrica.Italiano);

            Assert.AreEqual(
                "<h1>Rapporto sui moduli</h1>2 Piazze | La zona 29 | Perimetro 28 <br/>1 Cerchio | La zona 7,07 | Perimetro 9,42 <br/>2 Triangoli | La zona 42 | Perimetro 39 <br/>1 Rettangolo | La zona 40 | Perimetro 26 <br/>1 Trapezio | La zona 210 | Perimetro 30 <br/>TOTALE:<br/>7 formes Perimetro 132,42 La zona 328,07",
                resumen);
        }
    }
}
